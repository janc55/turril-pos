                            ...
                            @foreach ($menuProducts as $product)
                                @if ($product['type'] === 'sandwich')
                                    <button
                                        ...
                                        <div
                                            class="relative z-10 flex flex-col items-center justify-center text-center w-full">
                                            <span
                                                class="text-base font-bold truncate w-full">{{ $product['name'] }}</span>
                                            <span
                                                class="text-sm mt-1 font-medium">{{ number_format($product['price'], 2) }}
                                                Bs.</span>
                                        </div>
                                    </button>
                                @endif
